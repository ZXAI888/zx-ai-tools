...
const DEFAULT_REPO = 'SUZIXI-AI/zx-ai-tools';
const DEFAULT_CASK_PATH = 'Casks/zx-ai-tools.rb';
const DEFAULT_TARGET = 'universal-apple-darwin';
const DEFAULT_RELEASE_ASSET_PREFIX = 'ZX.AI.Tools';
...
function printHelp() {
  ...
  console.log('  --repo <owner/repo>     GitHub repo for release (default: SUZIXI-AI/zx-ai-tools)');
  console.log('  --cask <path>           Homebrew cask file path (default: Casks/zx-ai-tools.rb)');
...
function resolveSourceDmgPath(version, options) {
  ...
  const defaultPath = path.resolve(
    ...
    'bundle',
    'dmg',
    `ZX AI Tools_${version}_universal.dmg`
  );
...
function main() {
  ...
  console.log('ZX AI Tools GitHub Release + Homebrew cask publisher');
  ...
  console.log('- 检查 Casks/zx-ai-tools.rb diff');
